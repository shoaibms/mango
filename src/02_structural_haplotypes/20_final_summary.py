...
def load_baseline():
    ...
    # columns: trait, scheme, model_type, mean_r, std_r, n_folds, n_used, n_total
    # model_type is ridge_no_pc / ridge_pc etc. We’ll call this model and tag model_family="linear".
    df_out = df.copy()
